 ...
 * @param memory        The amount of memory available in bytes.
 ...
 *                      null-terminated string containing the result JSON. The
 *                      string is managed by the library and is valid until the
